 ...
 *
 * Whoever deploys this factory becomes its `protocolTreasury` — the 0.5% fee on every bond raised
 * through it is theirs. That's the whole economic point of running your own ASC: deploy your own
 * factory, and every bond your business (or your customers') funds through it pays you.
 */
